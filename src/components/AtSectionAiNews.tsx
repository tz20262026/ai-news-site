...
const items: AtItem[] = [
  {
    // 成果報酬 13,000円（2026-07-22追加）
    rk: "0100p03500ovms",
    badge: "🌐 リモートで使う回線を整える",
    badgeColor: "#e11d48",
    title: "SoftBank光",
    tagline: "ソフトバンク光｜開通で高額還元",
    desc: "AIツールでのファイルやり取り・オンライン会議が増えるほど、回線の安定性が効いてきます。ソフトバンク光は乗り換え・新規どちらも申し込める窓口です。",
    cta: "料金プランを見る →",
    color: "#e11d48",
  },
  {
    ...
    badgeColor: "#7c3aed",
    title: "退職代行Jobs",
    tagline: "会社に行かずに退職手続きを完了できるサービス",
    desc: "「今の仕事、AIに置き換わりそう」と感じて動きたいけど言い出せない——そんな時に、本人に代わって退職手続きを進めてくれるサービスです。",
    cta: "詳細を見る →",
    color: "#7c3aed",
  },
  {
    // 成果報酬 11,500円（2026-07-22追加）
    rk: "0100ppve00ovms",
    badge: "🤖 AIスキルを仕事に変える",
    badgeColor: "#0d9488",
    title: "WEBCOACH",
    tagline: "無料カウンセリングで学習の道筋を相談できる",
    desc: "AIニュースを追うだけでなく、Web制作やプログラミングを学んで手に職をつけたい人向けの無料カウンセリング。まず相談だけでもOKです。",
    cta: "無料相談を見る →",
    color: "#0d9488",
  },
  {
  ...
  {
    // 成果報酬 3,500円（2026-08-06追加）
    rk: "0100q2kh00ovms",
    badge: "🤖 AIスキルをセミナーで学ぶ",
    badgeColor: "#d97706",
    title: "AIスキルアカデミー",
    tagline: "生成AI活用を学べる無料セミナー",
    desc: "ニュースで生成AIの動向を追うだけでなく、実際に手を動かして使えるようになりたい人向けの無料セミナー。予約するだけで参加できます。",
    cta: "セミナーを予約する →",
    color: "#d97706",
  },
  {
    // 成果報酬 12,000円（2026-08-06追加）
    rk: "0100pzk500ovms",
    badge: "📶 外出先でAIツールを使う",
    badgeColor: "#0891b2",
    title: "PLAIO WiMAX",
    tagline: "工事不要のモバイルWi-Fi｜開通で高額還元",
    desc: "固定回線とは別に、外出先やカフェで生成AIツールを使う機会が増えた人向けのモバイルWi-Fi。工事不要ですぐ使い始められます。",
    cta: "料金プランを見る →",
    color: "#0891b2",
  },
  {
    // 成果報酬 7,333円（2026-08-06追加）
    rk: "0100pakv00ovms",
    badge: "🎸 AIの合間に手を動かす趣味を",
    badgeColor: "#f59e0b",
    title: "Beeミュージックスクール",
    tagline: "ギター・ピアノ・ベースの無料レッスン体験",
    desc: "画面を見続ける時間が長くなりがちな人向け。無料のレッスン体験から始められる音楽スクールで、AIに置き換わりにくい「手を動かすスキル」を持つ選択肢です。",
    cta: "無料体験を見る →",
    color: "#f59e0b",
  },
];
