...
// - 閉じたらセッション中は再表示しない
const STORAGE_KEY = "ainews-sticky-cta-closed";
...
export default function MobileStickyCTA() {
  ...
  return (
    ...
    >
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur border-t border-blue-100 dark:border-gray-700 shadow-[0_-4px_12px_rgba(0,0,0,0.1)] px-2 pt-1.5 pb-[max(0.375rem,env(safe-area-inset-bottom))]">
