...
const items = [
  {
    // 2026-08-26追加・成果報酬22,000円(新規無料相談実施2000円+新規契約20000円)・2026-08-17提携申請、08-25承認
    href: "https://px.a8.net/svt/ejp?a8mat=4BA7X5+EEKNRM+5VOU+5YRHE",
    badge: "🎬 動画編集×AI副業・超高単価",
    badgeColor: "#dc2626",
    title: "動画クリエイターPLUS",
    tagline: "案件獲得までサポートする動画編集×AI活用スクール",
    desc: "動画編集スキルにAI活用を掛け合わせ、副業案件の獲得までサポート。無料相談だけで成果になる高単価プログラム。",
    cta: "無料相談に申し込む →",
    color: "#dc2626",
  },
  {
    // 2026-08-25復元・成果報酬5,000円(新規有料プラン購入)・2026-07-22承認済みだが実装漏れが判明したため追加
