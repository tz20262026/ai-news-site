...
const SELF_URL = "https://ai-news-site-wheat.vercel.app";
      ...
      <ul className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-3">
        {sites.map((site) => (
          <li key={site.url}>
            <a
              href={site.url}
              className="block rounded-lg border border-gray-800 bg-gray-900/60 px-3 py-2.5 hover:border-blue-500/60 hover:bg-gray-900 transition-colors"
            >
