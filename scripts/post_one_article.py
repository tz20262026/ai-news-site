...
未掲載のAIツール1件を800〜1200字の日本語記事に生成し、
...
SYSTEM_INSTRUCTION = (
    ...
    "2. 記事本文の合計文字数は800〜1200文字を厳守すること。必ず800文字以上、1200文字以内で書くこと。\n"
...
[本文]
以下の構成で合計800〜1200文字の解説文を書くこと。箇条書き・見出し不可。流れるような文章で。
・導入（約150字）：このツールが解決する課題や背景を引き込む書き出しで。
・機能詳細（約450字）：主要機能・特徴・他ツールとの差別化を深掘り解説。
・活用シーン（約250字）：どんな職種・業種・シーンで役立つか具体的に。
・料金・開始方法（約200字）：無料プランの有無、料金体系、登録手順を簡潔に。
・まとめ（約150字）：魅力を一言で締め、読者の行動を促す一文で終わる。
